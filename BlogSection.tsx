  ...
  return (
    <section id="blog" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        {/* Newsletter CTA */}
        <div className="bg-gradient-primary rounded-2xl p-12 text-primary-foreground text-center fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-full bg-white/20 backdrop-blur-sm text-primary-foreground placeholder:text-primary-foreground/70 border border-white/30 focus:outline-none focus:ring-2 focus:ring-accent"
            />
